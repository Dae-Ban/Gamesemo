...
<div style="max-width: 600px; margin: 50px auto; padding: 30px; background: #fff; border-radius: 10px; font-family: 'Noto Sans KR', sans-serif;">
    ...
    <form action="${pageContext.request.contextPath}/rcreport/report/insert" method="post">
        <!-- 히든 필드: 신고 대상 테이블/글번호 -->
        <input type="hidden" name="rp_table" value="${rp_table}" />
        <input type="hidden" name="board_num" value="${board_num}" />

        <div style="margin-bottom: 15px;">
            <label for="rp_reason" style="font-weight: bold;">신고 사유</label><br>
            <textarea name="rp_reason" id="rp_reason" rows="6" style="width: 100%; padding: 10px;" placeholder="신고 사유를 입력하세요" required></textarea>
        </div>
