...
<div class="container">
  ...
  <form class="search-bar" method="get" action="/wishlist">
    <input type="text" name="keyword" placeholder="게임 제목 검색" value="${keyword}">
    <select name="order">
  ...
  <c:forEach var="game" items="${wishlist}">
    <div class="wishlist-item">
      ...
      <div class="price-info">
        <span class="original-price">₩${game.giPrice}</span>
        <span class="discount-price">₩${game.giFprice}</span>
        <span class="discount-rate">${game.giRate}%</span>
      </div>
